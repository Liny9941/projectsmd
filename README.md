...
5. Windows might show a security box. Click "More info" and then "Run anyway" if the screen appears.
...
Yes, only if you use online AI services to process your files. The app itself runs offline.

**Can I open these files in other programs?**
Yes. Since the files use markdown, you can open them in Notepad, Visual Studio Code, or any web-based markdown viewer.

**Is there a limit on file size?**
No, but keep the file concise for better performance. 

**Does this software modify my files?**
The software updates the markdown file when you save changes during your work sessions. It makes no other changes to your computer.
...
2. Check that no other instance of the program is currently running.
3. Try moving the folder to a location with full read and write permissions, like your user home folder.

If agents have trouble reading your file:
1. Ensure the syntax follows basic markdown rules.
2. Remove any special characters that might conflict with text parsing.
3. Include a short description at the top of the file to help the agent interpret your goals.